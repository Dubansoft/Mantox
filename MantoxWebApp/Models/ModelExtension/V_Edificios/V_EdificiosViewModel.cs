...
{
    /// <summary>
    /// Modelo parcial para la vista "V_Edificios". Contiene métodos encargados de traer información desde la vista "V_Edificios" de la base de datos.
    /// </summary>
    public partial class V_Edificios : MantoxViewModel
    {
        ...
        /// NOTA: El diccionario principal es devuelto por la función ObtenerTablaVistaDinamica() la cual es llamada por BuscarEdificios()
        /// </summary>
        ...
        /// <summary>
        /// Convierte un objeto de clase CrearEditarEdificioViewModel en un objeto de clase V_Edificios
        /// </summary>
        /// <param name="edificiovm">CrearEditarEdificioViewModel</param>
