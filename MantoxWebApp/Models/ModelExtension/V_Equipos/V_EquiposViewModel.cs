    ...
    public partial class V_Equipos : MantoxViewModel
    {
        ...
        public static explicit operator V_Equipos(Equipo e)
        {
            V_Equipos ve = new V_Equipos
            {
                ...
                Id_Sistema_Operativo = e.Id_Sistema_Operativo,
        ...
        public static explicit operator V_Equipos(CrearEditarEquipoViewModel equipovm)
        {
            V_Equipos ve = new V_Equipos
            {
                ...
                Nombre_de_Equipo = equipovm.Nombre_de_Equipo,
                Ip = equipovm.Ip,
                Fecha_de_Ingreso = equipovm.Fecha_de_Ingreso,
                Meses_de_Garantia = equipovm.Meses_de_Garantia,
                ...
                Id_Sistema_Operativo = equipovm.Id_Sistema_Operativo,
