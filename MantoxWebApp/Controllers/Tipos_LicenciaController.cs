...
{
    public class Tipos_LicenciaController : MantoxController
    {
        ...
        /// </summary>
        /// <returns>Vista V_Tipos_Licencias</returns>
        public async Task<ActionResult> Ver()
        {
            try
            {
                ...
                return VistaAutenticada(View(await bdMantox.V_Tipos_Licencias.ToListAsync()), RolDeUsuario.Desarrollador);
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Nombre")] Tipos_Licencia tipo_Licencia)
        {
            if (ModelState.IsValid)
            {
                bdMantox.Tipos_Licencia.Add(tipo_Licencia);
        ...
        public async Task<ActionResult> Edit(int? id)
        {
            ...
            Tipos_Licencia tipo_Licencia = await bdMantox.Tipos_Licencia.FindAsync(id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Nombre")] Tipos_Licencia tipo_Licencia)
        {
            if (ModelState.IsValid)
            {
                bdMantox.Entry(tipo_Licencia).State = EntityState.Modified;
                await bdMantox.SaveChangesAsync();
                return RedirectToAction("Index");
            }
            return View(tipo_Licencia);
        ...
        {
            Tipos_Licencia tipo_Licencia = await bdMantox.Tipos_Licencia.FindAsync(id);
            bdMantox.Tipos_Licencia.Remove(tipo_Licencia);
            await bdMantox.SaveChangesAsync();
            return RedirectToAction("Index");
        }
