...
function tableToGrid(a, b) {
    ...
    $.jgrid = $.jgrid || {}, $.extend($.jgrid, {
        ...
        parseDate: function(a, b, c, d) {
            ...
            else o = new Date(n.y, n.m, n.d, n.h, n.i, n.s, n.u); if (void 0 === c) return o;
...
function(a) {
    ...
    a.extend(a.jgrid, {
        ...
        createModal: function(b, c, d, e, f, g, h) {
            ...
            } else(0 !== d.left || 0 !== d.top) && (o.left = d.left, o.top = d.top + "px"); if (a("a.ui-jqdialog-titlebar-close", l).click(function() {
    ...
    a.jgrid.extend({
        ...
        filterInput: function(a, b) {
            return b = $.extend(!0, {
                ...
                var c = this;
                if (c.grid) {
                    //Changed, added new value searchString to JSON output 
                    //var d, e, f, g = '{"groupOp":"' + b.groupOp + '","rules":[',
                    var d, e, f, g = '{"searchString":"' + a.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') +'","groupOp":"' + b.groupOp + '","rules":[',
                        h = 0;
        ...
        editCell: function(b, c, d) {
            return this.each(function() {
                ...
                if (i.grid && i.p.cellEdit === !0) {
                    ...
                    }, 0); if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
